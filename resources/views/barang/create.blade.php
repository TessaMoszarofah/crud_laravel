                ...
                <div class="card-body">
                    <form action="{{ route('barang.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" class="form-control @error('stok') is-invalid @enderror"
                                name="stok" value="{{ old('stok') }}" rows="3" placeholder="stok"
                                required></textarea>
                            @error('stok')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" class="form-control @error('id_merek') is-invalid @enderror"
                                name="id_merek" value="{{ old('id_merek') }}" rows="3" placeholder="id_merek"
                                required></textarea>
                            @error('id_merek')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
